...
namespace atFrameWork2.PageObjects
{
    public class PortalLeftMenu
    {
        ...
        public SiteAndShopListPage OpenSitesAndShops()
        {
            ClickMenuItem(new WebItem("//li[@id='bx_left_menu_menu_shop']", "Пункт левого меню 'Сайты и Магазины'"));
            return new SiteAndShopListPage();
        }
