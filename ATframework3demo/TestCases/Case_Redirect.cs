...
namespace ATframework3demo.TestCases
{
    public class Case_Redirect : CaseCollectionBuilder
    {
        protected override List<TestCase> GetCases()
        {
            ...
            caseCollection.Add(new TestCase("Проверка перехода из карточки чужого рецепта на автора", (mainPage, info) => AuthorFromCard(mainPage,info)));
            caseCollection.Add(new TestCase("Проверка перехода из карточки своего рецепта на свою страницу", (mainPage, info) => OnMeFromCard(mainPage,info)));
